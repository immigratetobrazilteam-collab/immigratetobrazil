...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/:locale(en|pt)/blog/blog-:state.html',
        destination: '/:locale/state-guides/everything-you-need-to-know-about-:state',
        permanent: true,
      },
      {
        source: '/:locale(en|pt)/blog/blog-:state',
        destination: '/:locale/state-guides/everything-you-need-to-know-about-:state',
        permanent: true,
      },
      {
      ...
      {
        source: '/:locale(en|pt)/faq/:slug.html',
      ...
      {
        source: '/:locale(en|pt)/discover/index.html',
        destination: '/:locale/discover',
        permanent: true,
      },
      {
        source: '/:locale(en|pt)/discover/:path*/index.html',
        destination: '/:locale/discover/:path*',
        permanent: true,
      },
      {
        source: '/:locale(en|pt)/discover/:path*.html',
        destination: '/:locale/discover/:path*',
        permanent: true,
      },
      {
      ...
      {
        source: '/:locale(en|pt)/consultation/index.html',
  ...
  async headers() {
    ...
    return [
      {
        source: '/:locale(en|pt)/discover/:path*',
        headers: contentCacheHeaders,
      },
      {
        source: '/:locale(en|pt)/state-guides/:path*',
        headers: contentCacheHeaders,
      },
      {
        source: '/:locale(en|pt)/services/:path*',
        headers: contentCacheHeaders,
      },
      {
        source: '/:locale(en|pt)/faq/:path*',
        headers: contentCacheHeaders,
      },
      {
        source: '/:locale(en|pt)/about/:path*',
        headers: contentCacheHeaders,
      },
      {
        source: '/sitemap.xml',
