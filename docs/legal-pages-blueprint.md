...
- contact email: `immigratetobrazilteam@gmail.com`
- WhatsApp / phone: `+55 43 99132-4028`
...
Questions about any legal page may be directed to `immigratetobrazilteam@gmail.com`. If the issue is time-sensitive and connected to an active matter, contact may also be made by phone or WhatsApp at `+55 43 99132-4028`, but policy-level questions are generally easier to review and document through email.
...
If you wish to exercise a data right, submit the request to `immigratetobrazilteam@gmail.com`. We may require reasonable identity verification before acting on a request, particularly where the request concerns sensitive records, deletion, disclosure, or correction of service-related files.
...
Privacy, correction, deletion, and data-rights requests should be sent to `immigratetobrazilteam@gmail.com`.
...
Payment questions, transfer-matching issues, and proof-of-payment support requests should be sent to `immigratetobrazilteam@gmail.com`. Include the payer name, service stage, date, amount, payment method, and proof where available.
...
Requests should be sent to `immigratetobrazilteam@gmail.com` with the client name, service stage, payment amount, date, payment method, and the basis for the request.
...
If a form fails, an upload appears incomplete, or a technical issue prevents proper submission, contact `immigratetobrazilteam@gmail.com`. If the matter is urgent, note the technical issue and the urgency separately.
...
For purposes of this notice, the data controller for the public platform, intake communications, advisory contact, and related operational processing described here is Immigrate to Brazil, reachable at `immigratetobrazilteam@gmail.com`.
...
GDPR-related requests and questions should be sent to `immigratetobrazilteam@gmail.com`.
...
For purposes of this notice, the `controlador` of the personal-data processing described on this page is Immigrate to Brazil, acting through its operating team for platform, intake, communication, advisory, payment, and record-handling activities. Contact for LGPD matters is `immigratetobrazilteam@gmail.com`.
...
LGPD-related requests should be sent to `immigratetobrazilteam@gmail.com`.
...
If you encounter an accessibility issue, email `immigratetobrazilteam@gmail.com` and describe the page, the issue, and the task you were attempting. If email is not the easiest route, you may also contact us by phone or WhatsApp at `+55 43 99132-4028`.
