# https://immigratetobrazil.com/insights/guides/immigration-x-emigration-do-you-know-the-difference/
...
Current URL: https://immigratetobrazil.com/insights/guides/immigration-x-emigration-do-you-know-the-difference/
Recommended URL: https://immigratetobrazil.com/insights/guides/immigration-x-emigration-do-you-know-the-difference/
...
User problem / SEO objective: Immigration x Emigration: do you know the difference?
Desired action: Resolve the page-specific question; follow the relevant next-step link.
Primary topic/query: Immigration x Emigration: do you know the difference?
Primary keyword/focus field: Immigration x Emigration: do you know the difference?; editorial aid only, no meta keywords.
...
BEFORE title: Immigration x Emigration: do you know the difference? | July 7, 2025 | Brazil Guide | Immigrate to Brazil
BEFORE description: Immigration x Emigration: do you know the difference? This page brings earlier FAQ-style research into a clearer guidance page for readers planning...
...
H1: Immigration x Emigration: do you know the difference?
...
Publication context: July 7, 2025.
...
Links TO this page: https://immigratetobrazil.com/insights/ in the relevant topic group, using “Immigration x Emigration: do you know the difference?”; see the complete source/target table. A new contextual link is conditional on retaining the page’s distinct value.
...
Canonical: https://immigratetobrazil.com/insights/guides/immigration-x-emigration-do-you-know-the-difference/
Robots: index,follow. Self-canonical indexable proposal; actual Google index state unavailable.
Exact HTML: ../metadata/0340-insights--guides--immigration-x-emigration-do-you-know-the-difference.html
...
JSON-LD: ../schema/0340-insights--guides--immigration-x-emigration-do-you-know-the-difference.json. Wrap this valid JSON in `<script type="application/ld+json">` and replace the existing graph; do not append conflicting entities. Source-review gates apply to schema too.
Visible breadcrumb accompanying the proposal:

```html
<nav aria-label="Breadcrumb"><a href="https://immigratetobrazil.com/">Home</a> → <a href="https://immigratetobrazil.com/insights/">Brazil Immigration Guides and Insights</a> → <a href="https://immigratetobrazil.com/insights/guides/">Guides</a> → <a href="https://immigratetobrazil.com/insights/guides/immigration-x-emigration-do-you-know-the-difference/">Immigration x Emigration: do you know the difference?</a></nav>
```
