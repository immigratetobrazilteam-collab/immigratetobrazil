# https://immigratetobrazil.com/pt-br/insights/process/you-should-request-for-your-brazilian-id-to-be-renewed-at-least-90-day/
...
Current URL: https://immigratetobrazil.com/pt-br/insights/process/you-should-request-for-your-brazilian-id-to-be-renewed-at-least-90-day/
Recommended URL: https://immigratetobrazil.com/pt-br/insights/process/you-should-request-for-your-brazilian-id-to-be-renewed-at-least-90-day/
...
User problem / SEO objective: Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado
Desired action: Resolve the page-specific question; follow the relevant next-step link.
Primary topic/query: Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado
Primary keyword/focus field: Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado; editorial aid only, no meta keywords.
...
BEFORE title: Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado | 13 de abril de 2023 | Visão do processo | Imigre para o Brasil
BEFORE description: Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado: Esta página traz processos anteriores e apoia pesquisas de uma forma mais clara...
...
H1: Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado
...
Contexto da publicação: 13 de abril de 2023.
...
Links TO this page: https://immigratetobrazil.com/pt-br/insights/ in the relevant topic group, using “Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado”; see the complete source/target table. A new contextual link is conditional on retaining the page’s distinct value.
...
Canonical: https://immigratetobrazil.com/pt-br/insights/process/you-should-request-for-your-brazilian-id-to-be-renewed-at-least-90-day/
Robots: index,follow. Self-canonical indexable proposal; actual Google index state unavailable.
Exact HTML: ../metadata/1268-pt-br--insights--process--you-should-request-for-your-brazilian-id-to-be-renewed-at-least-90-day.html
...
JSON-LD: ../schema/1268-pt-br--insights--process--you-should-request-for-your-brazilian-id-to-be-renewed-at-least-90-day.json. Wrap this valid JSON in `<script type="application/ld+json">` and replace the existing graph; do not append conflicting entities. Source-review gates apply to schema too.
Visible breadcrumb accompanying the proposal:

```html
<nav aria-label="Breadcrumb"><a href="https://immigratetobrazil.com/pt-br/">Início</a> → <a href="https://immigratetobrazil.com/pt-br/insights/">Guias e informações sobre imigração no Brasil</a> → <a href="https://immigratetobrazil.com/pt-br/insights/process/">Processo</a> → <a href="https://immigratetobrazil.com/pt-br/insights/process/you-should-request-for-your-brazilian-id-to-be-renewed-at-least-90-day/">Você deve solicitar que seu ID brasileiro seja renovado pelo menos 90 dias antes de ser executado</a></nav>
```
