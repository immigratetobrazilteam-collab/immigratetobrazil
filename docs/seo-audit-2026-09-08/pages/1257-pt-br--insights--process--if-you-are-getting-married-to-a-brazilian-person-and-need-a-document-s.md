# https://immigratetobrazil.com/pt-br/insights/process/if-you-are-getting-married-to-a-brazilian-person-and-need-a-document-s/
...
Current URL: https://immigratetobrazil.com/pt-br/insights/process/if-you-are-getting-married-to-a-brazilian-person-and-need-a-document-s/
Recommended URL: https://immigratetobrazil.com/pt-br/insights/process/if-you-are-getting-married-to-a-brazilian-person-and-need-a-document-s/
...
User problem / SEO objective: Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando sua
Desired action: Resolve the page-specific question; follow the relevant next-step link.
Primary topic/query: Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando sua
Primary keyword/focus field: Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando sua; editorial aid only, no meta keywords.
...
BEFORE title: Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando sua | 5 de setembro de 2024 | Visão do processo | Imigre para o Brasil
BEFORE description: Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando: Esta página traz processos anteriores e apoia pesquisas de uma forma mais clara...
...
H1: Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando sua
...
Esta página traz processos anteriores e pesquisas de apoio de forma mais clara para leitores que coordenam documentos, autoridades e próximos passos em questões de imigração para o Brasil. Na prática, esta página trata de planejamento de imigração baseado na família e como as evidências de relacionamento afetam a rota.
...
Contexto da publicação: 5 de setembro de 2024.
...
Links TO this page: https://immigratetobrazil.com/pt-br/insights/ in the relevant topic group, using “Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando sua”; see the complete source/target table. A new contextual link is conditional on retaining the page’s distinct value.
...
Canonical: https://immigratetobrazil.com/pt-br/insights/process/if-you-are-getting-married-to-a-brazilian-person-and-need-a-document-s/
Robots: index,follow. Self-canonical indexable proposal; actual Google index state unavailable.
Exact HTML: ../metadata/1257-pt-br--insights--process--if-you-are-getting-married-to-a-brazilian-person-and-need-a-document-s.html
...
JSON-LD: ../schema/1257-pt-br--insights--process--if-you-are-getting-married-to-a-brazilian-person-and-need-a-document-s.json. Wrap this valid JSON in `<script type="application/ld+json">` and replace the existing graph; do not append conflicting entities. Source-review gates apply to schema too.
Visible breadcrumb accompanying the proposal:

```html
<nav aria-label="Breadcrumb"><a href="https://immigratetobrazil.com/pt-br/">Início</a> → <a href="https://immigratetobrazil.com/pt-br/insights/">Guias e informações sobre imigração no Brasil</a> → <a href="https://immigratetobrazil.com/pt-br/insights/process/">Processo</a> → <a href="https://immigratetobrazil.com/pt-br/insights/process/if-you-are-getting-married-to-a-brazilian-person-and-need-a-document-s/">Se você vai se casar com uma pessoa brasileira e precisa de um documento declarando sua</a></nav>
```
