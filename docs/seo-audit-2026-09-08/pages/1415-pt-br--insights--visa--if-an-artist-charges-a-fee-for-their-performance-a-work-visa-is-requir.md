# https://immigratetobrazil.com/pt-br/insights/visa/if-an-artist-charges-a-fee-for-their-performance-a-work-visa-is-requir/
...
Current URL: https://immigratetobrazil.com/pt-br/insights/visa/if-an-artist-charges-a-fee-for-their-performance-a-work-visa-is-requir/
Recommended URL: https://immigratetobrazil.com/pt-br/insights/visa/if-an-artist-charges-a-fee-for-their-performance-a-work-visa-is-requir/
...
User problem / SEO objective: Se um artista cobrar uma taxa pela sua apresentação, será necessário um visto de trabalho
Desired action: Resolve the page-specific question; follow the relevant next-step link.
Primary topic/query: Se um artista cobrar uma taxa pela sua apresentação, será necessário um visto de trabalho
Primary keyword/focus field: Se um artista cobrar uma taxa pela sua apresentação, será necessário um visto de trabalho; editorial aid only, no meta keywords.
...
BEFORE title: Se um artista cobrar uma taxa pela sua apresentação, será necessário um visto de trabalho | 28 de janeiro de 2025 | Informações sobre vistos | Imigre para o Brasil
BEFORE description: Se um artista cobrar uma taxa por sua apresentação, será necessário um visto de trabalho: Esta página reorganiza conteúdo anterior sobre vistos em um formato de planejamento da entrada no Brasil mais claro para...
...
H1: Se um artista cobrar uma taxa pela sua apresentação, será necessário um visto de trabalho
...
Contexto da publicação: 28 de janeiro de 2025.
...
Links TO this page: https://immigratetobrazil.com/pt-br/insights/ in the relevant topic group, using “Se um artista cobrar uma taxa pela sua apresentação, será necessário um visto de trabalho”; see the complete source/target table. A new contextual link is conditional on retaining the page’s distinct value.
...
Canonical: https://immigratetobrazil.com/pt-br/insights/visa/if-an-artist-charges-a-fee-for-their-performance-a-work-visa-is-requir/
Robots: index,follow. Self-canonical indexable proposal; actual Google index state unavailable.
Exact HTML: ../metadata/1415-pt-br--insights--visa--if-an-artist-charges-a-fee-for-their-performance-a-work-visa-is-requir.html
...
JSON-LD: ../schema/1415-pt-br--insights--visa--if-an-artist-charges-a-fee-for-their-performance-a-work-visa-is-requir.json. Wrap this valid JSON in `<script type="application/ld+json">` and replace the existing graph; do not append conflicting entities. Source-review gates apply to schema too.
Visible breadcrumb accompanying the proposal:

```html
<nav aria-label="Breadcrumb"><a href="https://immigratetobrazil.com/pt-br/">Início</a> → <a href="https://immigratetobrazil.com/pt-br/insights/">Guias e informações sobre imigração no Brasil</a> → <a href="https://immigratetobrazil.com/pt-br/insights/visa/">Visto</a> → <a href="https://immigratetobrazil.com/pt-br/insights/visa/if-an-artist-charges-a-fee-for-their-performance-a-work-visa-is-requir/">Se um artista cobrar uma taxa pela sua apresentação, será necessário um visto de trabalho</a></nav>
```
