# https://immigratetobrazil.com/insights/naturalisation/my-immigrant-card-is-valid-until-2030-but-my-stable-union-is-over/
...
Current URL: https://immigratetobrazil.com/insights/naturalisation/my-immigrant-card-is-valid-until-2030-but-my-stable-union-is-over/
Recommended URL: https://immigratetobrazil.com/insights/naturalisation/my-immigrant-card-is-valid-until-2030-but-my-stable-union-is-over/
...
User problem / SEO objective: My immigrant card is valid until 2030, but my stable union is over
Desired action: Resolve the page-specific question; follow the relevant next-step link.
Primary topic/query: My immigrant card is valid until 2030, but my stable union is over
Primary keyword/focus field: My immigrant card is valid until 2030, but my stable union is over; editorial aid only, no meta keywords.
...
BEFORE title: My immigrant card is valid until 2030, but my stable union is over | July 25, 2025 | Naturalisation Insight | Immigrate to Brazil
BEFORE description: My immigrant card is valid until 2030, but my stable union is over: This page brings earlier citizenship research into a clearer format for readers comparing...
...
H1: My immigrant card is valid until 2030, but my stable union is over
...
Publication context: July 25, 2025.
...
Links TO this page: https://immigratetobrazil.com/insights/ in the relevant topic group, using “My immigrant card is valid until 2030, but my stable union is over”; see the complete source/target table. A new contextual link is conditional on retaining the page’s distinct value.
...
Canonical: https://immigratetobrazil.com/insights/naturalisation/my-immigrant-card-is-valid-until-2030-but-my-stable-union-is-over/
Robots: index,follow. Self-canonical indexable proposal; actual Google index state unavailable.
Exact HTML: ../metadata/0433-insights--naturalisation--my-immigrant-card-is-valid-until-2030-but-my-stable-union-is-over.html
...
JSON-LD: ../schema/0433-insights--naturalisation--my-immigrant-card-is-valid-until-2030-but-my-stable-union-is-over.json. Wrap this valid JSON in `<script type="application/ld+json">` and replace the existing graph; do not append conflicting entities. Source-review gates apply to schema too.
Visible breadcrumb accompanying the proposal:

```html
<nav aria-label="Breadcrumb"><a href="https://immigratetobrazil.com/">Home</a> → <a href="https://immigratetobrazil.com/insights/">Brazil Immigration Guides and Insights</a> → <a href="https://immigratetobrazil.com/insights/naturalisation/">Naturalisation</a> → <a href="https://immigratetobrazil.com/insights/naturalisation/my-immigrant-card-is-valid-until-2030-but-my-stable-union-is-over/">My immigrant card is valid until 2030, but my stable union is over</a></nav>
```
