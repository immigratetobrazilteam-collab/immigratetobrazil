...
const content: Record<Locale, ApplyCopy> = {
  ...
  fr: {
    title: 'Demandez votre installation au Brésil avec un processus juridique maîtrisé',
    subtitle:
      'Cette version migrée remplace le modèle statique historique par un flux structuré pour les visas et résidences.',
    steps: [
      { title: 'Cartographie de l’éligibilité', detail: 'Définir la base migratoire correcte avant de collecter les pièces.' },
      { title: 'Architecture documentaire', detail: 'Organiser origine, traduction, légalisation et validité de chaque document.' },
      { title: 'Stratégie de dépôt', detail: 'Déposer avec contrôle qualité, cohérence des preuves et pilotage des délais.' },
      { title: 'Suivi post-dépôt', detail: 'Suivre les demandes, répondre aux clarifications et sécuriser l’approbation finale.' },
    ],
    checklistTitle: 'Checklist prioritaire avant dépôt',
    checklist: [
      'Passeport et actes civils vérifiés sur les fenêtres de validité',
      'Preuves financières/professionnelles alignées avec la catégorie de visa',
      'Traductions assermentées et légalisations cartographiées',
      'Séquence locale préparée pour CPF et enregistrement migratoire',
    ],
  },
};
