    ...
    <>
      <section className="border-b border-sand-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-civic-700">About Brazil</p>
          <h1 className="mt-4 font-display text-5xl text-ink-900">Brazil content library</h1>
