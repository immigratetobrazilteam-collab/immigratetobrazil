...
import { getAboutBrazilStateParams, getStaticLocales } from '@/lib/static-export';
import type { Locale } from '@/lib/types';

export const revalidate = 3600;

export function generateStaticParams() {
  return getStaticLocales().flatMap((locale) =>
    getAboutBrazilStateParams(locale).map((param) => ({
      locale,
      slug: param.slug,
      state: param.state,
    })),
