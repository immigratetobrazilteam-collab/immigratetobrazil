...
import { getAboutBrazilSlugs, getStaticLocales } from '@/lib/static-export';
import type { Locale } from '@/lib/types';

export const revalidate = 3600;

export function generateStaticParams() {
  return getStaticLocales().flatMap((locale) => getAboutBrazilSlugs(locale).map((slug) => ({ locale, slug })));
}
