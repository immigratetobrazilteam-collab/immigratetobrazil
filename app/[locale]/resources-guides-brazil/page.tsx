...
const content: Record<Locale, GuideCopy> = {
  ...
  fr: {
    title: "Ressources et guides opérationnels pour l'immigration au Brésil",
    subtitle:
      'Hub moderne de ressources remplaçant les blocs statiques historiques par des catégories structurées.',
    items: [
      { title: 'Guides par catégorie de visa', detail: 'Arbres de décision, éligibilité et standards documentaires.' },
      { title: 'Guides par État', detail: 'Coût régional, climat, flux juridiques et infrastructure.' },
      { title: "Opérations d'arrivée", detail: 'Références CPF, CRNM/RNE, logement, santé, école et banque.' },
      { title: 'Alertes conformité', detail: 'Renouvellements, fenêtres de validité et points de contrôle procéduraux.' },
    ],
  },
};
