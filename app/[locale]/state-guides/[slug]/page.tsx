...
import { getStaticLocales, getStateGuideSlugs } from '@/lib/static-export';
import {
  getStateGuideBySlug,
...
export function generateStaticParams() {
  const slugs = getStateGuideSlugs();
  return getStaticLocales().flatMap((locale) => slugs.map((slug) => ({ locale, slug })));
}
