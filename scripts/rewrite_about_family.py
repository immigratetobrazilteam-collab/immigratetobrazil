...
PHONE = "+55 43 9961-4034"
WHATSAPP_URL = "https://api.whatsapp.com/send/?phone=554399614034&text=Hello+I+would+like+to+talk+to+attorney+Monique&type=phone_number&app_absent=0"
LOGO_MAIN = "/assets/logo/logo.png"
LOGO_TRANSPARENT = "/assets/logo/logo.png"
...
HERO_PORTRAITS = {
    "/about/": {
        "src": "/assets/images/pages/about/overview/hero/monique-fernandes-brazil-immigration-attorney-overview-page-portrait.webp",
        "alt": "Monique Fernandes, Brazilian immigration attorney supporting clients in Brazil and abroad.",
    },
    "/about/about/": {
        "src": "/assets/images/pages/about/about/hero/monique-fernandes-brazil-immigration-attorney-about-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the About Monique Fernandes page.",
    },
    "/about/clients/": {
        "src": "/assets/images/pages/about/clients/hero/monique-fernandes-brazil-immigration-attorney-clients-page-portrait.webp",
        "alt": "Monique Fernandes, Brazilian immigration attorney supporting clients in Brazil and abroad.",
    },
    "/about/ethics/": {
        "src": "/assets/images/pages/about/ethics/hero/monique-fernandes-brazil-immigration-attorney-ethics-page-portrait.webp",
        "alt": "Monique Fernandes, Brazilian immigration attorney supporting clients in Brazil and abroad.",
    },
    "/about/story/": {
        "src": "/assets/images/pages/about/story/hero/monique-fernandes-brazil-immigration-attorney-story-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Story page.",
    },
    "/about/lawyer/": {
        "src": "/assets/images/pages/about/lawyer/hero/monique-fernandes-brazil-immigration-attorney-lawyer-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Lawyer page.",
    },
    "/about/profile/": {
        "src": "/assets/images/pages/about/profile/hero/monique-fernandes-brazil-immigration-attorney-profile-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Profile page.",
    },
    "/about/mission/": {
        "src": "/assets/images/pages/about/mission/hero/monique-fernandes-brazil-immigration-attorney-mission-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Mission page.",
    },
    "/about/philosophy/": {
        "src": "/assets/images/pages/about/philosophy/hero/monique-fernandes-brazil-immigration-attorney-philosophy-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Philosophy page.",
    },
    "/about/values/": {
        "src": "/assets/images/pages/about/values/hero/monique-fernandes-brazil-immigration-attorney-values-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Values page.",
    },
    "/about/whyus/": {
        "src": "/assets/images/pages/about/whyus/hero/monique-fernandes-brazil-immigration-attorney-why-work-with-monique-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Why Work With Monique page.",
    },
    "/about/results/": {
        "src": "/assets/images/pages/about/results/hero/monique-fernandes-brazil-immigration-attorney-results-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Results page.",
    },
    "/about/stories/": {
        "src": "/assets/images/pages/about/stories/hero/monique-fernandes-brazil-immigration-attorney-stories-page-portrait.webp",
        "alt": "Monique Fernandes, Brazilian immigration attorney supporting clients in Brazil and abroad.",
    },
    "/about/testimonials/": {
        "src": "/assets/images/pages/about/testimonials/hero/monique-fernandes-brazil-immigration-attorney-testimonials-page-portrait.png",
        "alt": "Monique Fernandes, Brazilian immigration attorney, for the Testimonials page.",
    },
}
...
CTA_MEDIA = {
    "src": "/assets/images/pages/about/shared/consultation/monique-fernandes-brazil-immigration-attorney-consultation-portrait.webp",
    "alt": "Monique Fernandes, Brazilian immigration attorney, ready to discuss a consultation."
}
    ...
    while i < len(lines):
        ...
        if line == "Hero chips:":
            ...
            while i < len(lines) and lines[i].strip().startswith("- "):
                ...
                i += 1
            continue
        if line == "Hero signals:":
            i += 1
            while i < len(lines) and lines[i].strip().startswith("- "):
                hero["signals"].append(strip_ticks(lines[i].strip()[2:].strip()))
                i += 1
            continue
        if ":" in line:
...
def hero_portrait_for(route: str) -> dict:
    return HERO_PORTRAITS.get(route, DEFAULT_PORTRAIT)


def derive_glance_cards(page: dict) -> list[dict]:
    if page["route"] == "/about/":
        return [
            {"label": "Who Monique Is", "value": "Start here to understand the attorney behind Immigrate to Brazil and the standards that shape her work."},
            {"label": "How To Use This Family", "value": "Move from the hub into the page that best answers your question about Monique, her method, or her client experience."},
            {"label": "Best Next Move", "value": "Use consultation if you want Monique to review your own chronology, route, and documentation context."},
        ]
...
def render_hero(page: dict, image: dict) -> str:
    ...
    signals = hero.get("signals") or ["Since 2018", "English and Portuguese", "Clients in Brazil and abroad", "Remote service"]
    portrait = hero_portrait_for(page["route"])
    badge_html = "".join(
    ...
    portrait_html = f"""
          <figure style="margin:0 0 1rem 0;">
            <img src="{portrait['src']}" alt="{html.escape(portrait['alt'])}" width="720" height="900" loading="eager" decoding="async" style="display:block;width:100%;max-width:320px;margin:0 auto 0.85rem;border-radius:1.25rem;box-shadow:0 24px 60px rgba(0,0,0,.22);object-fit:cover;" />
            <figcaption style="text-align:center;font-size:.95rem;opacity:.88;">Monique Fernandes</figcaption>
          </figure>""".rstrip()
    return f"""
...
<div class="hero-meta">
        <div class="hero-panel hero-panel--brand">
          ...
          <p class="hero-brand-tagline">Empowering Immigrants - Promoting Brazil</p>
          <p class="hero-brand-note">{html.escape(hero.get('summary', ''))}</p>
        </div>
<div class="hero-panel hero-panel--signals">
          <strong>Practice signals</strong>
...
def render_hub_menu(preview_pages: dict[str, dict], existing: dict[str, dict]) -> str:
  ...
  <section class="content-block highlight-block" id="about-menu">
      <h2 class="section-title"><span class="section-title__icon" aria-hidden="true">{icon}</span><span>Explore Monique's practice</span></h2>
      <p>Use the About Hub as a structured menu into Monique Fernandes' immigration practice, proof, standards, and client experience.</p>
...
def render_about_hub_content(page: dict, preview_pages: dict[str, dict], existing: dict[str, dict]) -> str:
    sections = page["sections"]
    intro = render_intro(sections[0]) if sections else ""
    section_two = render_section(sections[1], "topic-section--split") if len(sections) > 1 else ""
    section_three = render_section(sections[2], "topic-section--frame") if len(sections) > 2 else ""
  ...
  <section class="lead-form-block" id="consultation-form">
    ...
    <div class="card-grid compact">
      <article class="info-card">
        <img src="{CTA_MEDIA['src']}" alt="{html.escape(CTA_MEDIA['alt'])}" width="320" height="320" loading="lazy" decoding="async" style="display:block;width:120px;height:120px;object-fit:cover;border-radius:999px;margin:0 auto 1rem;" />
        <h3>Monique Fernandes</h3>
        <p>Attorney-led immigration guidance in English and Portuguese, with remote support for clients in Brazil and abroad.</p>
      </article>
      <article class="info-card">
...
def render_body(page: dict, preview_pages: dict[str, dict], existing: dict[str, dict]) -> str:
    ...
    sections = page["sections"]
    if page["route"] == "/about/":
        article_html = render_about_hub_content(page, preview_pages, existing)
    else:
        intro = render_intro(sections[0]) if sections else ""
...
SEO_TITLES = {
    "/about/": "About Monique Fernandes | Brazil Immigration Attorney | Immigrate to Brazil",
    "/about/about/": "Meet Monique Fernandes | Brazil Immigration Attorney | Immigrate to Brazil",
    "/about/profile/": "Monique Fernandes Profile | Brazil Immigration Attorney | Immigrate to Brazil",
    "/about/mission/": "Monique Fernandes Mission | Empowering Immigrants in Brazil | Immigrate to Brazil",
    "/about/philosophy/": "Monique Fernandes Philosophy | Brazil Immigration Practice | Immigrate to Brazil",
    "/about/story/": "Monique Fernandes Story | Brazil Immigration Attorney | Immigrate to Brazil",
    "/about/values/": "Monique Fernandes Values | Immigration Practice Standards | Immigrate to Brazil",
    "/about/lawyer/": "Monique Fernandes | OAB/BAR Registered Attorney | Immigrate to Brazil",
    "/about/whyus/": "Why Work With Monique Fernandes | Brazil Immigration Attorney | Immigrate to Brazil",
    "/about/results/": "Immigration Results With Monique Fernandes | Brazil | Immigrate to Brazil",
    "/about/stories/": "Brazil Immigration Stories | Monique Fernandes | Immigrate to Brazil",
    "/about/clients/": "Who Monique Fernandes Helps | Brazil Immigration Clients | Immigrate to Brazil",
    "/about/testimonials/": "Client Testimonials | Monique Fernandes | Brazil Immigration | Immigrate to Brazil",
    "/about/ethics/": "Monique Fernandes Ethics | Brazil Immigration Practice | Immigrate to Brazil",
}


def title_suffix(page: dict) -> str:
    return SEO_TITLES.get(page["route"], f"{page['label']} | Monique Fernandes | Immigrate to Brazil")
